export const theme = Object.freeze({
  ...
  colors: {
    ...
    onlineColor: '#ceecce',
    offlineColor: '#dab9b9',
    mainTextColor: '#010101',
    secondTextColor: '#768696',
    thirdTextColor: '#1f3349',
    mainBorderColor: '#d8e0ea',
    friendsBorderColor: '#7c7979',
    statsBorderColor: '#e4e9f0',
    statsBackgroundColor: '#f3f6f9',
    avatarBackgroundColor: '#9a7e6b',
    tableHeaderBackgroundColor: '#00bcd5',
    tableCellMarkedBackgroundColor: '#ecf1f4',
    location: '#768696',
    mainShadowColor: '#bdbbbb',
  },
  //? ------------------------------
  //   fonts: ,
  //? ------------------------------
  fontSizes: ['16px', '20px', '22px', '30px', '35px'],
